                    ...
                    <tbody>
                        @foreach ($articles as $article)
                            <tr>
                                ...
                                <td class="align-left">{!! Html::link(route('article.edit', ['articles' => $article->alias]), $article->title) !!}</td>
                                ...
                                <td>{{ $article->alias }}</td>
                                <td>
                                    {!! Form::open(['url' => route('article.destroy', ['articles' => $article->alias]), 'class'=>'form-horizontal', 'method' => 'POST']) !!}
                                    {{ method_field('DELETE') }}
