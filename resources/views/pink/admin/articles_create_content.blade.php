<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open(['url' => (isset($article->id)) ? route('article.update', ['articles' => $article->alias]) : route('article.store'), 'class'=>'contact-form', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        ...
        <ul>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend">
                    <span class="add-on"><i class="icon-user"></i></span>
                    {!! Form::text('keywords', isset($article->keywords) ? $article->keywords : old('keywords'), ['placeholder' => 'Введите ключи']) !!}
                </div>
            </li>

            <li class="text-field">
                <label for="name-contact-us">
                    <span class="label">Мета оописание:</span>
                    <br>
                    <span class="sublabel">Заголовок материала</span><br>
                </label>
                <div class="input-prepend">
            ...
            <li class="textarea-field">
                ...
                <div class="input-prepend">
                    <span class="add-on"><i class="icon-user"></i></span>
                    {!! Form::textarea('desc', isset($article->desc) ? $article->desc : old('desc'), ['placeholder' => 'Введите краткое описание', 'id' => 'editor']) !!}
                </div>
            </li>
